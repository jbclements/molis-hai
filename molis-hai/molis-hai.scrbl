...
These booleans are generated by drawing randomness using @racket[crypto-random-bytes].
...
These passwords are as secure as the bits that come from @racket[crypto-random-bytes]. In fact,
